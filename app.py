...
def home():
    ...
    return f"this is a database. to add data, send a post request to the /set page with the key, value, and password. to get data, send a get request to the /get page with the key. to delete data, send a delete request to /del with the key and password.    {data}"
